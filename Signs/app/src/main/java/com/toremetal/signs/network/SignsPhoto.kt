 ...
 *   ************************************************************************
 *     SignsPhoto.kt : Copyright (c) 2025 ™T©ReMeTaL.
 *   ************************************************************************
...
/**
 * ### data class [SignsPhoto] defines a Signs photo object.
 * #### &nbsp;&nbsp; val [id]: String, object id.
 * #### &nbsp;&nbsp; var [imgSrcUrl]: String, Image URL.
 * #### &nbsp;&nbsp; val [imgVal]: String, object title/label.
 * #####  note: The property names are used by Moshi to match the names of values in JSON.
 */
@Keep
