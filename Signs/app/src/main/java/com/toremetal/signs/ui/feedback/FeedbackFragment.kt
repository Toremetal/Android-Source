 ...
 *   ************************************************************************
 *     FeedbackFragment.kt : Copyright (c) 2025 ™T©ReMeTaL.
 *   ************************************************************************
...
package com.toremetal.signs.ui.feedback
...
import com.toremetal.signs.databinding.FeedbackFragmentBinding
...
private class MyWebViewClient : WebViewClient() {
    ...
    override fun shouldOverrideUrlLoading(view: WebView?, url: String?): Boolean {
        ...
        if (Uri.parse(url).host == "forms.gle") {
            return false
        }
        try {
