...
import com.toremetal.signs.DetailActivity.Companion.IMG
import com.toremetal.signs.DetailActivity.Companion.LETTER
import com.toremetal.signs.data.translate
import com.toremetal.signs.databinding.GridItemBinding
...
class PhotoGridAdapter2 :
    ListAdapter<SignsPhotos, PhotoGridAdapter2.SignsPhotosViewHolder>(DiffCallback) {

    /**
     * The SignsPhotosViewHolder constructor takes the binding variable from the associated
     * GridViewItem, which nicely gives it access to the full [SignsPhotos] information.
     */
    class SignsPhotosViewHolder(
         ...
         *
         */
        fun bind(signsPhoto: SignsPhotos) {
            binding.photos = signsPhoto
     ...
     * [SignsPhotos] has been updated.
     */
    companion object DiffCallback : DiffUtil.ItemCallback<SignsPhotos>() {
        /**
         *
         */
        override fun areItemsTheSame(oldItem: SignsPhotos, newItem: SignsPhotos): Boolean {
         ...
         *
         */
        override fun areContentsTheSame(oldItem: SignsPhotos, newItem: SignsPhotos): Boolean {
